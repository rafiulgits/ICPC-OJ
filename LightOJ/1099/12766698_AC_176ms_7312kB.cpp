...
int main()
{
    ...
    for(int c=1; c<=Case; c++)
    {
        ...
        /*:::::::::::::: How ????  :::::::::::::::
          when you find find any shortest distance for any particular node
          before update its shortest distance array update the second shortest
          array with the value of previous shortest distance then update the shortest
          distance. Use another condition-> if first distance condition does not match for
          any of its connected node then check whether second distance need to update or not.
          there is no visited array. let the graph traverse itself in cyclic mode with with
          condition of first shortest and second shortest condition
